	...
	function htmlUserBar(){
		...
		<nav class="navbar navbar-default navbar-fixed-top hidden-print" role="navigation">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo PREPEND_PATH; ?>index.php"><i class="glyphicon glyphicon-home"></i> Kongres Pemuda Intelek Warisan Nusantara</a>
			</div>
			<div class="collapse navbar-collapse">
				...
				<?php if(!$_GET['signIn'] && !$_GET['loginFailed']){ ?>
					...
					<?php }else{ ?>
						<ul style="margin-top: 7px;" class="nav navbar-nav navbar-right hidden-xs" style="min-width: 330px;">
