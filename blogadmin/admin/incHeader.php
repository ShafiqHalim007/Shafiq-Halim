...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	<head>
		...
		<title><?php echo ucwords('Kongres Pemuda Intelek Warisan Nusantara') . ' | ' . $Translation['admin area']; ?><?php echo html_attr(isset($GLOBALS['page_title']) ? " | {$GLOBALS['page_title']}" : ''); ?></title>
	...
	<div class="container theme-yeti theme-compact">
		...
		<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="pageHome.php"><span style="color:#ffffff;" class="text-info"><i class="glyphicon glyphicon-sunglasses"></i> <?php echo $Translation['admin area']; ?></span></a>
			</div>
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li class="divider"></li>
<!--							<li><a href="https://forums.appgini.com" target="_blank"><i class="glyphicon menu-item-icon text-info glyphicon-new-window"></i><?php /*?> <?php echo $Translation['AppGini forum']; ?><?php */?></a></li>-->
						</ul>
					</li>
