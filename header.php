			...
			<div class="row">
				<div class="col-md-4 logo text-left">
					<a class="navbar-brand" href="index.php">
						<img style="border-radius: 50%;width: 8vw;height: auto;" src="images/profile.jpg" alt="menu-img"/>
          <container>
            <row><strong>Shafiq Halim</strong></row>
            <row> <p style="margin: -50px 120px;">Kongres Pemuda Intelek Warisan Nusantara</p></row>
   </container>
          </a>
      
				</div>
				<div class="col-md-4 top-forms text-center mt-lg-4 mt-md-1 mt-0">
<!--
					<span><strong style="font-size: 2em;">اَلسَلامُ عَلَيْكُم </strong></span>
...
-->
          ...
          <ul class="social_list1 mt-4 top-forms">
            <a href="blogadmin/index.php">
							<i class="fas fa-lock"></i> <strong style="color:#777777;"> Sign In</strong></a>
            		<a href="blogadmin/membership_signup.php">
							<i style="margin-left: 3em;" class="far fa-user"></i> <strong style="color:#777777;"> Register</strong></a>
          </ul>
				</div>
			</div>
		</div>
